...
class Editor {
  ...
  deleteTask(i) {
    _toDoList_js__WEBPACK_IMPORTED_MODULE_0__.List.TaskList = _toDoList_js__WEBPACK_IMPORTED_MODULE_0__.List.TaskList.filter((t, index) => t.index !== i);
    this.setIndex();
    _toDoList_js__WEBPACK_IMPORTED_MODULE_0__.List.saveToLS();
